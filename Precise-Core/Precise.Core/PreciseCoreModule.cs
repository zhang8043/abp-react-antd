...
namespace Precise
{
    ...
    public class PreciseCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            PreciseLocalizationConfigurer.Configure(Configuration.Localization);
            ...
            Configuration.MultiTenancy.IsEnabled = PreciseConsts.MultiTenancyEnabled;
            ...
            Configuration.ReplaceService<IMailKitSmtpBuilder, PreciseMailKitSmtpBuilder>(DependencyLifeStyle.Transient);
            ...
            Configuration.ReplaceService(typeof(IEmailSenderConfiguration), () =>
            {
                Configuration.IocManager.IocContainer.Register(
                    Component.For<IEmailSenderConfiguration, ISmtpEmailSenderConfiguration>()
                             .ImplementedBy<PreciseSmtpEmailSenderConfiguration>()
                             .LifestyleTransient()
                );
            });
            ...
            {
                cache.DefaultSlidingExpireTime = TimeSpan.FromMinutes(PreciseConsts.PaymentCacheDurationInMinutes);
            });
        }

        public override void Initialize()
        {
            IocManager.RegisterAssemblyByConvention(typeof(PreciseCoreModule).GetAssembly());
        }
