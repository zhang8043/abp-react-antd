...
using Precise.Auditing.Exporting;
using Precise.Authorization;
using Precise.Authorization.Users;
using Precise.Dto;
using EntityHistoryHelper = Precise.EntityHistory.EntityHistoryHelper;

namespace Precise.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : PreciseAppServiceBase, IAuditLogAppService
    {
